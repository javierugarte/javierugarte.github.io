document.addEventListener('DOMContentLoaded', () => {
	const translations = {
		es: {
			...
			'section.skills.title': 'Tecnologías',
			'skills.mobile.label': 'Mobile',
			'skills.tooling.label': 'Herramientas y prácticas',
			...
			'projects.rankit.description': 'App web colaborativa para crear listas compartidas y votar en grupo. Rankea películas, series, libros y videojuegos con sincronización en tiempo real.',
		...
		en: {
			...
			'section.skills.title': 'Technologies',
			'skills.mobile.label': 'Mobile',
			'skills.tooling.label': 'Tooling & Practices',
			...
			'projects.rankit.description': 'Collaborative web app for shared lists and group voting. Rank movies, TV shows, books and games with real-time sync.',
